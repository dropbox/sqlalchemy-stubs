...
class OrderedSet(Set[_T]):
    ...
    def __iter__(self) -> Iterator[_T]: ...
    def __add__(self, other: Iterable[_T]) -> _OS: ...
    def update(self: _OS, iterable: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __ior__(self: _OS, iterable: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def union(self: _OS, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __or__(self: _OS, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def intersection(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __and__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def symmetric_difference(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __xor__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def difference(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __sub__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def intersection_update(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __iand__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    # signature incompatible with supertype
    def symmetric_difference_update(self, other: Iterable[_T]) -> _OS: ...  # type: ignore
    def __ixor__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def difference_update(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
    def __isub__(self, other: Iterable[_T]) -> _OS: ...  # type: ignore  # signature incompatible with supertype
