...
class MapperExtension:
    ...
    def instrument_class(self, mapper, class_) -> symbol: ...
    def init_instance(self, mapper, class_, oldinit, instance, args, kwargs) -> symbol: ...
    def init_failed(self, mapper, class_, oldinit, instance, args, kwargs) -> symbol: ...
    def reconstruct_instance(self, mapper, instance) -> symbol: ...
    def before_insert(self, mapper, connection, instance) -> symbol: ...
    def after_insert(self, mapper, connection, instance) -> symbol: ...
    def before_update(self, mapper, connection, instance) -> symbol: ...
    def after_update(self, mapper, connection, instance) -> symbol: ...
    def before_delete(self, mapper, connection, instance) -> symbol: ...
    def after_delete(self, mapper, connection, instance) -> symbol: ...