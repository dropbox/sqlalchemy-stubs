from typing import Any, Optional, TypeVar, Generic, List, Iterator
...
# _T is set by a plugin to either a single type (eg. Query[MyModel]) or a tuple (Query[MyModel, int, str, float])
class Query(Generic[_T]):
    ...
    def offset(self, offset: Optional[int]) -> _Q: ...
