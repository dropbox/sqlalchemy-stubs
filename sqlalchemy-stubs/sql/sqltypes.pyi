...
from .type_api import TypeEngine as TypeEngine, TypeDecorator as TypeDecorator, Emulated
...
class Interval(Emulated, _LookupExpressionAdapter, TypeDecorator[timedelta]):  # type: ignore
