...
class TextClause(Executable, ClauseElement):
    ...
    key: Any = ...
    text: str = ...
    def __init__(self, text: Text, bind: Optional[Union[Engine, Connection]] = ...) -> None: ...
    def bindparams(self: _TC, *binds: BindParameter[Any], **names_to_values: Any) -> _TC: ...
    ...
    def self_group(self: _TC, against: Optional[Any] = ...) -> Union[_TC, Grouping[None]]: ...
    def get_children(self, **kwargs: Any) -> List[BindParameter[Any]]: ...
    def compare(self, other: Any) -> bool: ...  # type: ignore
    @classmethod
    def _create_text(cls: Type[_TC], text: Text, bind: Optional[Union[Engine, Connection]] = ...,
...
class ClauseList(ClauseElement):
    ...
    def self_group(self: _CL, against: Optional[Any] = ...) -> Union[_CL, Grouping[Any]]: ...
    def compare(self, other: Any, **kw: Any) -> bool: ...
...
@overload
def literal_column(text: str, type_: Optional[Type[TypeEngine[_T]]] = ...) -> ColumnClause[TypeEngine[_T]]: ...
@overload
def literal_column(text: str, type_: Optional[TypeEngine[_T]] = ...) -> ColumnClause[TypeEngine[_T]]: ...
...
class Cast(ColumnElement[_T]):
    ...
    def get_children(self, **kwargs: Any) -> _TupleType[ClauseElement, TypeClause[TypeEngine[_T]]]: ...
...
class TypeCoerce(ColumnElement[_T]):
    ...
    @overload
    def __init__(self, expression: ColumnElement[Any], type_: Type[TypeEngine[_T]]) -> None: ...
    @overload
    def __init__(self, expression: str, type_: TypeEngine[_T]) -> None: ...
    @overload
    def __init__(self, expression: ColumnElement[Any], type_: TypeEngine[_T]) -> None: ...
...
class UnaryExpression(ColumnElement[_T]):
    ...
    def __init__(self, element: Any, operator: Optional[Callable[..., Any]] = ..., modifier: Optional[Any] = ...,
                 type_: Optional[Type[TypeEngine[_T]]] = ..., negate: Optional[Any] = ...,
    ...
    @classmethod
    def _create_desc(cls, column: Union[ColumnElement[Any], str]) -> UnaryExpression[NullType]: ...
    @classmethod
    def _create_asc(cls, column: Union[ColumnElement[Any], str]) -> UnaryExpression[NullType]: ...
    @classmethod
...
class CollectionAggregate(UnaryExpression[_T]):
    ...
    @overload
    @classmethod
    def _create_any(cls, expr: List[Any]) -> CollectionAggregate[Any]: ...
...
class BinaryExpression(ColumnElement[_T], Generic[_T, _U, _V]):
    ...
    @overload
    def __init__(self, left: ColumnClause[_U], right: ColumnClause[_V], operator: Callable[..., Any],
                 type_: Optional[TypeEngine[_T]] = ..., negate: Optional[Any] = ..., modifiers: Optional[Any] = ...) -> None: ...
...
class Over(ColumnElement[_T]):
    ...
    def __init__(self, element: WithinGroup[_T],
                 ...
                 range_: Optional[_TupleType[Optional[int], Optional[int]]] = ...) -> None: ...
    @overload
    def __init__(self, element: WithinGroup[_T],
                 partition_by: Optional[Union[str, ColumnElement[Any], Iterable[Union[str, ColumnElement[Any]]]]] = ...,
                 order_by: Optional[Union[str, ColumnElement[Any], Iterable[Union[str, ColumnElement[Any]]]]] = ...,
                 rows: Optional[_TupleType[Optional[int], Optional[int]]] = ...) -> None: ...
    @overload
...
class WithinGroup(ColumnElement[_T]):
    ...
    def __init__(self, element: FunctionElement[_T], *order_by: Union[str, ColumnElement[Any]]) -> None: ...
    def over(self, partition_by: Optional[Union[str, ColumnElement[Any], Iterable[Union[str, ColumnElement[Any]]]]] = ...,
             order_by: Optional[Union[str, ColumnElement[Any], Iterable[Union[str, ColumnElement[Any]]]]] = ...) -> Over[_T]: ...
    @property
    def type(self) -> TypeEngine[_T]: ...
...
class Label(ColumnElement[_T]):
    ...
    @overload
    def __init__(self, name: str, element: ColumnElement[Any], type_: Type[TypeEngine[_T]] = ...) -> None: ...
    @overload
    def __init__(self, name: str, element: ColumnElement[Any], type_: TypeEngine[_T] = ...) -> None: ...
...
class ColumnClause(Immutable, ColumnElement[_T]):
    ...
    is_literal: bool = ...
    @overload
    def __init__(self, text: str, type_: Optional[Type[TypeEngine[_T]]] = ..., is_literal: bool = ...,
                 _selectable: Optional[TableClause] = ...) -> None: ...
    @overload
    def __init__(self, text: str, type_: Optional[TypeEngine[_T]] = ..., is_literal: bool = ...,
                 _selectable: Optional[TableClause] = ...) -> None: ...
    @property
