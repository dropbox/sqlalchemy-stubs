from typing import (
    Any, Optional, Union, Type, TypeVar, Generic, Callable, List, Dict, Set, Iterator, Tuple as _TupleType, overload
)
...
class Tuple(ClauseList, ColumnElement[_T]):
    type: _T = ...
    @overload
    def __init__(self, *clauses: ColumnElement[Any], type_: Type[_T], **kw: Any) -> None: ...
    @overload
    def __init__(self, *clauses: ColumnElement[Any], type_: _T, **kw: Any) -> None: ...
    @overload
