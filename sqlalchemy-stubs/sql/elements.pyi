...
class Case(ColumnElement[TypeEngine[_T]], Generic[_T]):
    ...
    else_: Any = ...
    @overload
    def __init__(self, whens: Iterable[_TupleType[ClauseElement, _T]], else_: Optional[_T] = ...) -> None: ...
    @overload
...
class Cast(ColumnElement[_TE], Generic[_TE, _OTE]):
    __visit_name__: str = ...
    type: _TE = ...
    clause: ClauseElement = ...
    typeclause: TypeClause[_TE] = ...
    @overload
    def __init__(self, expression: Union[str, ColumnElement[_OTE]], type_: Type[_TE]) -> None: ...
    @overload
    def __init__(self, expression: Union[str, ColumnElement[_OTE]], type_: _TE) -> None: ...
...
class Grouping(ColumnElement[Union[_TE, NullType]], Generic[_TE]):
    __visit_name__: str = ...
    element: ColumnElement[_TE] = ...
    type: Union[_TE, NullType] = ...
...
class Label(ColumnElement[_TE]):
    ...
    @property
    def type(self) -> Union[_TE, NullType]: ...  # type: ignore  # This return type is not compatible with ColumnElement.type
    @property
...
class ColumnClause(Immutable, ColumnElement[_TE]):
    ...
    type: Union[_TE, NullType] = ...  # type: ignore
    is_literal: bool = ...
    @overload
