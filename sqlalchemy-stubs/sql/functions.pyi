...
class FunctionElement(Executable, ColumnElement[_TE], FromClause, Generic[_TE]):  # type: ignore
...
class next_value(GenericFunction[_TE]):
    ...
    def __init__(self, seq: Sequence[_TE], **kw) -> None: ...
...
class array_agg(GenericFunction[sqltypes.ARRAY[_TE]], Generic[_TE]): ...
