from typing import Any, Optional, Set, Generic, TypeVar, overload, Union, Type
...
_T = TypeVar('_T')
_PType = Union[_PythonType[_T], Type[_PythonType[_T]]]
...
class Column(SchemaItem, ColumnClause, Generic[_T]):
    ...
    info: Any = ...
    @overload
    def __init__(self, name: str, type_: _PType[_T], *args, **kwargs) -> None: ...
    @overload
    def __init__(self, type_: _PType[_T], *args, **kwargs) -> None: ...
