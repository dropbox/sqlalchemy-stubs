...
from .sqltypes import _PythonType
...
class Column(SchemaItem, ColumnClause, Generic[_T]):
    ...
    info: Any = ...
    @overload
    def __init__(self, name: str, type_: _PythonType[_T], *args, **kwargs) -> None: ...
    @overload
    def __init__(self, type_: _PythonType[_T], *args, **kwargs) -> None: ...
    @overload
    def __init__(self, name: str, type_: Type[_PythonType[_T]], *args, **kwargs) -> None: ...
    @overload
    def __init__(self, type_: Type[_PythonType[_T]], *args, **kwargs) -> None: ...
    @overload
