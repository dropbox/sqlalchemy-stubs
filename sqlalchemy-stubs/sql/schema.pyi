...
_NamingConventionType = Union[Mapping[str, str],
                              Mapping[Index, str],
                              Mapping[Constraint, str],
                              Mapping[Union[str, Index], str],
                              Mapping[Union[str, Constraint], str],
                              Mapping[Union[Index, Constraint], str],
                              Mapping[Union[str, Index, Constraint], str]]

class MetaData(SchemaItem):
    __visit_name__: str = ...
    tables: util.immutabledict[str, Table] = ...
    schema: Optional[str] = ...
    naming_convention: _NamingConventionType = ...
    info: Optional[Mapping[str, Any]] = ...
    bind: _MetaDataBind = ...
    def __init__(self, bind: Optional[Union[Engine, Connection]] = ..., reflect: bool = ..., schema: Optional[str] = ...,
                 quote_schema: Optional[bool] = ..., naming_convention: _NamingConventionType = ...,
