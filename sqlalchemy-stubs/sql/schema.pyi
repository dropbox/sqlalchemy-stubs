...
class Column(SchemaItem, ColumnClause[_T]):
    ...
    info: Any = ...
    @overload
    def __init__(self, name: str, type_: Type[TypeEngine[_T]], *args, primary_key: Any = ..., nullable: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, type_: Type[TypeEngine[_T]], *args, primary_key: Any = ..., nullable: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, name: str, type_: TypeEngine[_T], *args, primary_key: Any = ..., nullable: bool = ..., **kwargs) -> None: ...
    @overload
    def __init__(self, type_: TypeEngine[_T], *args, primary_key: Any = ..., nullable: bool = ..., **kwargs) -> None: ...
    @overload
