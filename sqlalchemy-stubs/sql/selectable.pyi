...
class FromClause(Selectable):
    ...
    schema: Optional[str] = ...
    def count(self, whereclause: Optional[ClauseElement] = ..., **params: Any) -> Select: ...
    ...
    def outerjoin(self, right: FromClause, onclause: Optional[FromClause] = ..., full: bool = ...) -> Join: ...
...
class Join(FromClause):
    ...
    def select(self, whereclause: Optional[ClauseElement] = ..., **kwargs: Any) -> Select: ...
    @property
...
class TableClause(Immutable, FromClause):
    ...
    def insert(self, values: Optional[Mapping[str, Any]] = ..., inline: bool = ..., **kwargs: Any) -> Insert: ...
    def update(self, whereclause: Optional[ClauseElement] = ..., values: Optional[Mapping[str, Any]] = ..., inline: bool = ...,
               **kwargs: Any) -> Update: ...
...
class GenerativeSelect(SelectBase):
    ...
    def __init__(self, use_labels: bool = ..., for_update: bool = ..., limit: Optional[int] = ...,
                 offset: Optional[int] = ..., order_by: Optional[Sequence[ClauseElement]] = ...,
                 group_by: Optional[Sequence[ClauseElement]] = ..., bind: Optional[Union[Engine, Connection]] = ...,
    ...
    def limit(self: _GS, limit: int) -> _GS: ...
    def offset(self: _GS, offset: int) -> _GS: ...
    def order_by(self: _GS, *clauses: ClauseElement) -> _GS: ...
    def group_by(self: _GS, *clauses: ClauseElement) -> _GS: ...
    def append_order_by(self, *clauses: ClauseElement): ...
    def append_group_by(self, *clauses: ClauseElement): ...
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    __visit_name__: str = ...
    def __init__(self, columns: Optional[Sequence[Union[ColumnElement[Any], FromClause]]] = ...,
                 whereclause: Optional[ClauseElement] = ...,
                 from_obj: Optional[Sequence[ClauseElement]] = ..., group_by: Optional[Sequence[ClauseElement]] = ...,
                 having: Optional[ClauseElement] = ..., order_by: Optional[Sequence[ClauseElement]] = ...,
    ...
    def with_only_columns(self: _SE, columns: Sequence[ColumnElement[Any]]) -> _SE: ...
    def where(self: _SE, whereclause: ClauseElement) -> _SE: ...
    def having(self: _SE, having: ClauseElement) -> _SE: ...
    ...
    def append_whereclause(self, whereclause: ClauseElement) -> None: ...
    def append_having(self, having: ClauseElement) -> None: ...
