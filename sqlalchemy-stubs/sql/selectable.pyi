from typing import Any, Optional, Union, TypeVar, List, Iterable, Sequence, Mapping, Set, Tuple, Type, overload
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    __visit_name__: str = ...
    def __init__(self, columns: Union[None, int, Iterable[Union[ColumnElement[Any], FromClause, int]]] = ...,
    ...
    def is_derived_from(self, fromclause: FromClause) -> bool: ...
    def filter(self: _SE, criteria: Union[str, bool, Visitable]) -> _SE: ...
    def filter_by(self, **kwargs: Any) -> _SE: ...
...
class Exists(UnaryExpression):
    __visit_name__: Any = ...
    @overload
    def __init__(self, arg: Union[None, bool, int, float, SelectBase, ScalarSelect, ColumnClause], **kwargs: Any) -> None: ...
    # a hack: if there is a sequence with select, this must be a sequence of size 1
    # so, we're disabling using Selects in the Sequence, as this is a rare case anyway
    @overload
    def __init__(self, arg: Tuple[Union[SelectBase, ScalarSelect]], **kwargs: Any) -> None: ...
    @overload
    def __init__(self, arg: Iterable[Union[None, bool, int, float, Visitable, ColumnClause]], **kwargs: Any) -> None: ...
    @overload
    def __init__(self, *args: Union[None, bool, int, float, ColumnClause], **kwargs: Any) -> None: ...
    def select(self, whereclause: Optional[Union[str, bool, Visitable]] = ..., **params: Any) -> Select: ...
